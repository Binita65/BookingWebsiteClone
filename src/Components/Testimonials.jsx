  ...
  const CreateCard = ({ card }) => (
    <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
      ...
      <p className="text-sm py-4 text-gray-800">
        Loved the modern design of the room, the bed was super comfy, and service was excellent.
      </p>
  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 pt-20 pb-30'>
      <Title 
        ...
        subTitle="Our guests enjoy warm hospitality, seamless service, and unforgettable comfort, making every stay feel like home away from home." 
      />
