     ...
     <div className='text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                        At [Hotel Name], hospitality meets elegance. Located in the heart of [City Name], our hotel offers world-class amenities, cozy rooms, and personalized service to make your stay truly unforgettable.
                    </p>
